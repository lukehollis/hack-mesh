...
namespace Unity.MLAgentsExamples
{
    ...
    /// </summary>
    public class BirdActuator : IActuator
    {
        public BirdController basicController;
        ActionSpec m_ActionSpec;
        const float moveSpeed = 0.5f;

        public BirdActuator(BirdController controller)
        {
